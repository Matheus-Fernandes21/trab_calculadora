package exercicios;
		...
		public class calculadora2 extends JFrame {
			...
			//Funcionamento:
			// tela: tudo que aparece na tela através dos botões vira string pra tela.
			//slot: transforma as strings da variavel tela em float.
			//a, b, c: os valores de slot são armazenados primeiro em a, depois em b, e a conta é salva em c.
			//op: diz se estou ou nao fazendo uma operação. É o que vai definir se o que tiver na variavel Slot será salvo em a, b ou c.
			//cont == 0 a operação foi encerrada ou nao iniciou, cont == 1 está em andamento.
			// sum, sub, mult, div: a que estiver true será executada.
			...
			public calculadora2() {
				...
				divisao.setBounds(134, 279, 70, 57);
				...
				multiplicacao.setBounds(201, 223, 70, 57);
				...
				subtracao.setBounds(201, 167, 70, 57);
